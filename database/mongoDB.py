...
# print(db.get_topics())
# db.save_message(Message("Yarik", "1", "1", db.get_topics()[0]["_id"]))
# db.save_message(Message("Yarik", "1", "1", db.get_topics()[0]["_id"]))
# db.save_message(Message("Max", "1", "1", db.get_topics()[0]["_id"]))
# db.save_message(Message("Vadem", "1", "1", db.get_topics()[0]["_id"]))
# db.save_message(Message("Andrian", "1", "1", db.get_topics()[0]["_id"]))
# db.save_message(Message("Dr Dre", "1", "1", db.get_topics()[0]["_id"]))
